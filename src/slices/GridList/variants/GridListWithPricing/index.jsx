                    ...
                    <PrismicRichText field={item.body} components={{
                        ...
                        listItem: ({ children }) => (
                            <li className="flex items-center gap-x-3">
                                <svg height="12px" width="12px" viewBox="0 0 24 24" className="fill-current h-7 w-5 flex-none text-indigo-500" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
